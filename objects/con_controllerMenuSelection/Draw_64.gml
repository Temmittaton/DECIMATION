if (check) {
	...
	if (room != Menu) && (light) {
		...
		var _x = buttons [button].x + buttons [button].sprite_width * buttons [button].image_xscale * 8;
		var _y = buttons [button].y + buttons [button].sprite_height * buttons [button].image_yscale * 4;
		
		draw_sprite_ext (spr_sword, 0, _x, _y, .15, .15, 0, c_white, 1);
