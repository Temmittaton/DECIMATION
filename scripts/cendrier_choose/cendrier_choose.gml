function cendrier_choose(){
	...
	else if (state != cendrier_shield_charge) && (state != cendrier_shield) && (point_distance(x, y, obj_player.x, obj_player.y) <= 32){
	...
	else if (state == cendrier_dash) && ((x < 65) or (x > room_width - 65)){
